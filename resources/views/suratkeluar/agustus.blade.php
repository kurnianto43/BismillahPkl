        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabel Data Surat Keluar Agustus</h3>
              <a style="margin-left: 5px;" class="btn btn-default pull-right" href="{{ route('suratkeluar.index') }}">Kembali</a>
              <a style="margin-left: 5px;" class="btn btn-default pull-right" href="{{ route('suratkeluar.pdfags') }}"><i class="fa fa-print"></i></a>
            </div>
