...
<div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="{{ route('instansi.store') }}" method="POST" enctype="multipart/form-data">
              {{ csrf_field() }}
              <div class="box-body">
                ...
                <div class="form-group {{ $errors->has('nama_instansi') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="nama_instansi" value="{{ old('nama_instansi') }}" id="nama_instansi">
